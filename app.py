...
st.set_page_config(page_title="Manutenção V10 Fábrica", page_icon="🏭", layout="wide")
...
header("⚙️ Centro de Manutenção Industrial • SEM INATIVOS", "Versão V10 AJUSTADA SEM INATIVOS • MTBF REAL")
if auto_msgs:
